...
def main():
    ...
    parser.add_argument('--folder_gt', type=str, default="results/swinir_color_dn_noise15/M_256", help='input ground-truth test image folder')
    # parser.add_argument('--folder_gt', type=str, default="results\swinir_real_sr_x4\M", help='input ground-truth test image folder')
